# Generated by Django 4.1.2 on 2023-10-17 09:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='purchases', to='amsapp.book2')),
                ('book_title', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='amsapp.book2')),
                ('dealers', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='amsapp.dealers2')),
            ],
        ),
        migrations.CreateModel(
            name='WishlistItem',
